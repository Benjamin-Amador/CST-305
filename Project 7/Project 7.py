...
xVal = int(input("X starting value: "))
yVal = int(input("Y starting value: "))
zVal = int(input("Z starting value: "))
rhoVal = int(input("Rho starting value: "))
sigmaVal = int(input("Sigma starting value: "))
betaVal = int(input("Beta starting value: "))

# Set initial values
xs[0], ys[0], zs[0] = (xVal, yVal, zVal)
...
for i in range(num_steps):
    if xs[i] >= 17:  #This is the Critical Threshold. you can change this at anytime by adjusting the number.
        ...
        x_dot, y_dot, z_dot = lorenz(xs[i], ys[i], zs[i], sigmaVal, rhoVal, betaVal)
